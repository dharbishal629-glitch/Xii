// Vercel serverless function entry point (JavaScript — avoids tsc type checking).
  // ncc bundles all .ts imports via transpileOnly, so Express/Drizzle type
  // errors in the source never block this build.
  import app from "../artifacts/api-server/src/app";
  import { pool } from "../lib/db/src/index";

  // Init DB tables on cold start (the standalone src/index.ts normally does this,
  // but Vercel's entry is here, so we do it ourselves).
  pool.query(`
